...
` +
  ...
  const stockPiezas = Math.max(0, (stock.bovino_pieza || 0) + (stock.pieza_pierna || 0) + (stock.pieza_cuarto_pistola || 0) + (stock.pieza_costillar || 0) + (stock.pieza_cortito || 0) + (stock.pieza_costeletal || 0) + (stock.pieza_paleta || 0) + (stock.pieza_parrillero || 0))
