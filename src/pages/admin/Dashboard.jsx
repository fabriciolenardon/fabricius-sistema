...
` +
  ...
  const stockPiezas = Math.max(0, (stock.bovino_pieza || 0) + (stock.pieza_pierna || 0) + (stock.pieza_cuarto_pistola || 0) + (stock.pieza_costillar || 0) + (stock.pieza_cortito || 0) + (stock.pieza_carre || 0) + (stock.pieza_costeletal || 0) + (stock.pieza_paleta || 0) + (stock.pieza_parrillero || 0))
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
          {[
            ...
            { label: '🍖 Piezas Bovinas', valor: fmtKg(stockPiezas), color: 'var(--gold)', aprox: 'al peso', bajo: stockPiezas < 30, stockKg: stockPiezas, tiposEntradas: ['bovino_pieza','pieza_pierna','pieza_cuarto_pistola','pieza_costillar','pieza_cortito','pieza_carre','pieza_costeletal','pieza_paleta','pieza_parrillero'], tiposSalidas: ['bovino_pieza','pieza_entera','pieza_pierna','pieza_cuarto_pistola','pieza_costillar','pieza_cortito','pieza_carre','pieza_costeletal','pieza_paleta','pieza_parrillero'] },
